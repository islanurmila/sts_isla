            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="https://karyasiswa.site/" class="logo d-flex  w-auto">
                  <img src="https://karyasiswa.site/public/assets/img/logo.png" alt="">
              ...
              <!-- tampilkan pesan error -->
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="dashboard.php">
                    ...
                    <div class="col-12">
                      <label for="token" class="form-label">Tempat lahir</label>
                      <div class="input-group has-validation">
                        <input type="text" name="token" class="form-control" id="token" value="">
                        <div class="invalid-feedback">Please enter your tempatlahir.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <label for="konfirpassword" class="form-label">konfimasi password </label>
                      <input type="password" name="passwordconfirm" class="form-control" id="konfirpassword" value="">
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>

                    <div class="col-12">
                      <button class="btn btn-warning w-100" type="submit">Buat Akun</button>
                    </div>
                    <div class="col-12">
